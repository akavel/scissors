-----------------------------------------------------------------------------
-- Name:        ...
-- Purpose:     Loading image embedded in a Lua string
-- Author:      J Winwood
-- Modified by: Mateusz Czaplinski (08.2009)
-- Created:     16/11/2001
...
function load_image()
    local embeddedImage = require('embedded_image').data
    -- print 'pre'
    local inputStream = wx.wxMemoryInputStream(embeddedImage, #embeddedImage)
    -- print 'post'
    -- print '0'
    -- local c = inputStream.
    -- print '1'
